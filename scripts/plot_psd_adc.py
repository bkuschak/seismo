# Plot PSD of the ADC with shorted inputs 
...
psd_vel, f_vel = plt.mlab.psd(ch_low, Fs=fs, detrend=mlb.detrend_mean, NFFT=1024*1024)
...
# Velocity PSD
plt.figure()
plt.plot(f_vel, psd_vel, label='PSN-ADC24')
...
plt.ylim(-200,-50)
plt.xlim(0.001,100)		# Hz
plt.xscale('log')
plt.title('Ground velocity power spectral density. PSN-ADC24 output scaled for Yuma-2.\nCH1 inputs shorted. 200 SPS. 17.0 divider. 5 hours data')

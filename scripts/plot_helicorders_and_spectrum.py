...
Helicorder(st, MakeFilename(st, 'helicorder_microseism', 'png'), 
    location, starttime, 86400, freqmin=0.15, freqmax=0.5, decimation=1,
    scale=scale_microseism_helicorder_line)
